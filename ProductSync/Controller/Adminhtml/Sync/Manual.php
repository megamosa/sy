    ...
    public function execute()
    {
        ...
        if ($batchNumber === 0) {
            ...
            try {
                ...
                $this->syncService->setInProgress(false);
                $this->logger->critical('Error initiating manual sync: ' . $e->getMessage(), ['exception' => $e]);
            ...
            try {
                ...
                $this->logger->critical('Error processing batch ' . $batchNumber . ': ' . $e->getMessage(), ['exception' => $e]);
